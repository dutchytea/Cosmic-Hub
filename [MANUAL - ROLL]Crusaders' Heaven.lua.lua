...
do
	local ui = game:GetService("CoreGui"):FindFirstChild("Cosmic")
	if ui then
		ui:Destroy()
	end
end
...
local win = Flux:Window("Crusaders'", "COSMIC HUB", Color3.fromRGB(26, 26, 26), Enum.KeyCode.RightShift)
local tab = win:Tab("Stand Roller [Manual]", "http://www.roblox.com/asset/?id=6023426915")


tab:Toggle("Arrow Searcher", "Search for Arrows :/" , false, function(t)
    ...
    while _G.on do wait()
		...
		for i,v in pairs(game:GetChildren()) do
			if v:FindFirstChild("Stand Arrow") then
				...
				fireclickdetector(v["Stand Arrow"].ClickDetector)
			end
		end
		end
end)

tab:Button("Serverhop", "Hop to other servers", function()
 serverhop()
end)
...
tab:Bind("Roll [Bindable]", Enum.KeyCode.K, function()
    roll()
            wait(7)
...
tab:Bind("Reset [Bindable]", Enum.KeyCode.L, function()  
    reset()
end)

tab:Line()

tab:Button("Get Discord Link", "..." , function()
    setclipboard('https://discord.gg/UFQq3YWrfV')
end)